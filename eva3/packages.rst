...
Packages can be installed either via :ref:`install_pkg <eva3_sysapi_install_pkg>`
API method of any controller or with :ref:`IaC deployment<eva3_iac_pkg>` (in
this case, only :doc:`uc/uc` or :doc:`lm/lm` packages can be installed, or
the controller should have corresponding writing permissions to install e.g. UI
files).
