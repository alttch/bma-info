...
.. py:exception:: AccessDenied(msg='', kb=None)
   :module: eva.pluginapi
   :canonical: eva.exceptions.AccessDenied
...
.. py:exception:: FunctionFailed(msg='', kb=None)
   :module: eva.pluginapi
   :canonical: eva.exceptions.FunctionFailed
...
.. py:exception:: InvalidParameter
   :module: eva.pluginapi
   :canonical: eva.tools.InvalidParameter
...
.. py:class:: MQTT(notifier_id)
   :module: eva.pluginapi
   :canonical: eva.uc.drivers.tools.mqtt.MQTT
...
.. py:exception:: MethodNotFound
   :module: eva.pluginapi
   :canonical: eva.api.MethodNotFound
...
.. py:exception:: MethodNotImplemented(msg='', kb=None)
   :module: eva.pluginapi
   :canonical: eva.exceptions.MethodNotImplemented
...
.. py:exception:: ResourceAlreadyExists(msg='', kb=None)
   :module: eva.pluginapi
   :canonical: eva.exceptions.ResourceAlreadyExists
...
.. py:exception:: ResourceBusy(msg='', kb=None)
   :module: eva.pluginapi
   :canonical: eva.exceptions.ResourceBusy
...
.. py:exception:: ResourceNotFound(msg='', kb=None)
   :module: eva.pluginapi
   :canonical: eva.exceptions.ResourceNotFound
...
.. py:exception:: TimeoutException(msg='', kb=None)
   :module: eva.pluginapi
   :canonical: eva.exceptions.TimeoutException
