...
You can connect Arduino or similar boards to :doc:`../uc/uc` to handle events
...
any API inside a board, then just use :doc:`external scripts<../item_scripts>`
or :doc:`develop own PHI module <../phi_development>` to link :doc:`../uc/uc`
and board.
...
*udpapi/hosts-allow* options in *config/uc/main* :doc:`registry<../registry>`
key (don't forget to restart :doc:`../uc/uc` after configuration is modified).
