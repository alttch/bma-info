...
* Switch from MQTT to :ref:`PSRT <eva3_psrt_>`. Do not forget to tune
...
* To speed up event synchronization between controllers, switch to
  :ref:`eva3_lurp`.

* The good idea is also to reduce event real-timing and use
  :ref:`eva3_bulk_notify`.
