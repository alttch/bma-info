...
:ref:`Units<eva3_unit>` receive control actions, the controller forms them into
:ref:`queues<eva3_uc_queues>` and executes them using external scripts. If
...
Units and :ref:`sensors<eva3_sensor>` are controlled via :doc:`uc_ei`
interface, :doc:`configured<../items>` via :doc:`uc_api`. States are controlled
and updated using :doc:`drivers<../drivers>` and :doc:`item
...
.. literalinclude:: ../cfg/uc_main.yml
    :language: yaml
