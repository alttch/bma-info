...
:doc:`EVA JS Framework </eva-js-framework/index>` is used to build web browser
...
* **set_timeout(timeout)** set maximum request timeout (seconds), 5 seconds by
  default.
* **set_product(product)** set controller type: *uc* for :doc:`uc/uc`, *lm* for
  :doc:`lm/lm`, *sfa* for :doc:`sfa/sfa`. The client automatically
