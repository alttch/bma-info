...
* The server provides a dedicated :doc:`EAPI <eapi>` (via :doc:`BUS/RT
  <../../busrt/index>`) and :doc:`HTTP API <http_api>` for data streams which
  can be used on client side to form huge data frames with low costs of
  resources
